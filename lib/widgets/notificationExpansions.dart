...
class notificationExpansions extends StatefulWidget {
  //final Future<Settings> importSettings;
  final bool showPastEvents;
  final bool darkMode;
  const notificationExpansions({super.key, required this.darkMode, required this.showPastEvents});

  @override
  State<notificationExpansions> createState() => _notificationExpansionsState();
}

class _notificationExpansionsState extends State<notificationExpansions> {
  ...
  Widget build(BuildContext context) {
    //Settings newSettings = widget.importSettings;
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "App Settings",
      ...
      children: [
        Container(
          ...
          child: FlutterSwitch(
              ...
              onToggle: (val) {
                setState(() {
                  appSettings.notifications[1].Practice = val;
                });
              }),
        ),
        Text(itemName),
